...
|--------|------|------------|
| 1 | Setpoint | Click to modify the target temperature. A number between 0% and 100% (Add the percent symbol) puts the fan into manual mode. Press ENTER to submit, ESC to cancel. |
