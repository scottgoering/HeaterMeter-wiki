### This board has been replaced by the V3.2 PCB

The HeaterMeter V3.1 PCB is identified by the silkscreen on the back reading "LinkMeter V3.1" or from the top by the 74LS164 14 pin DIP shift register.

[HeaterMeter V3.1 PCB](http://capnbry.net/linkmeter/pcb/hm-3.1/)
