To produce a small finished product, the connection of the LCD to the HeaterMeter v4.2 board is done in a somewhat unorthodox manner. The LCD is mounted flush _under_ the HeaterMeter PCB.
